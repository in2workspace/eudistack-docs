...
![Barra de navegación inferior — pestaña Ajustes](../../assets/img/users/wallet-eudiw/nav-bottom-setting.png){ width="240" }
...
??? "Desenfoque de privacidad"
    ...
    **Predeterminado:** desactivado.
    ...
    ![Ajuste de desenfoque de privacidad activado en Ajustes](../../assets/img/users/wallet-eudiw/privacy.png){ width="240" }
...
??? "Modo oscuro"
    ...
    **Predeterminado:** desactivado (tema claro).
    ...
    ![Ajuste de modo oscuro en Ajustes](../../assets/img/users/wallet-eudiw/mode.png){ width="240" }
...
??? "Cámara seleccionada"
    ...
    ![Pantalla de selección de cámara en Ajustes](../../assets/img/users/wallet-eudiw/camera.png){ width="240" }
...
??? "Selector de idioma"
    ...
    ![Pantalla de selección de idioma en Ajustes](../../assets/img/users/wallet-eudiw/language.png){ width="240" }
...
??? "Base de conocimiento"
    ...
    ![Enlace a la base de conocimiento en Ajustes](../../assets/img/users/wallet-eudiw/docks.png){ width="240" }
...
??? "Mis Dispositivos <small>— solo Business Wallet</small>"
    ...
    ![Campo Mis Dispositivos en Ajustes](../../assets/img/users/wallet-buisiness/my-divices.png){ width="240" }
