...
-   :material-wallet: **Wallet — EUDIW**
    ...
    El wallet **personal**. Las claves y credenciales se guardan en tu propio dispositivo. Pensado para ciudadanos y profesionales que gestionan su identidad de forma autónoma.

    [:octicons-arrow-right-24: Empezar](wallet-eudiw/index.md)
...
Antes de contactar con soporte, revisa la sección de [solución de problemas](troubleshooting.md): cubre los errores y dudas más frecuentes.
